  ...
  return (
    <div className='portfolio__container__project'>
      ...
      >
        ...
        >
          <img src={nasaApod} alt='nasaApod' className='portfolio__container__project__info__image-container__image' />
        </div>
        <div
          className='portfolio__container__project__info__buttons'
          style={styles.buttons}
        >
          <a href='https://react-ntl-nasa-apod.netlify.app/' target='_blank' rel='noreferrer'>
            <button className='portfolio__container__project__info__buttons__live-site'> LIVE SITE </button>
          </a>
          <a href='https://github.com/Alelsito/react-nasa-apod' target='_blank' rel='noreferrer'>
