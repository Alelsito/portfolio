...
import marvelComics from '@/assets/Projects/marvel-comics.png'
  ...
  return (
    <div className='portfolio__container__project'>
      ...
      >
        ...
        >
          <img src={marvelComics} alt='marvelComics' className='portfolio__container__project__info__image-container__image' />
        </div>
        <div
          className='portfolio__container__project__info__buttons'
          style={styles.buttons}
        >
          <a href='https://marvel-comics-consuming-api.netlify.app/' target='_blank' rel='noreferrer'>
            <button className='portfolio__container__project__info__buttons__live-site'> LIVE SITE </button>
          </a>
          <a href='https://github.com/Alelsito/marvel-comics-api' target='_blank' rel='noreferrer'>
