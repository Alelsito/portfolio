...
import breakingBad from '@/assets/Projects/breaking-bad.png'
    ...
    <div className='portfolio__container__project'>
      ...
      >
        <p
          ...
          style={styles.text}
        >
          BREAKING-BAD (Searcher)
        </p>
        <div
          className='portfolio__container__project__info__image-container'
          style={styles.display}
        >
          <img src={breakingBad} alt='breakingBad' className='portfolio__container__project__info__image-container__image' />
        </div>
        <div
          className='portfolio__container__project__info__buttons'
          style={styles.buttons}
        >
          <a href='https://breaking-bad-consuming-api.netlify.app/' target='_blank' rel='noreferrer'>
            <button className='portfolio__container__project__info__buttons__live-site'> LIVE SITE </button>
          </a>
          <a href='https://github.com/Alelsito/breaking-bad-api' target='_blank' rel='noreferrer'>
